...
/**
 * Utility methods for dealing with dates. This class provides some safe ways to work with java.util.Date objects, by
 * using GregorianCalendars to do conversions.
 */
...
/*  TODO
    public static Calendar getFirstDayOfQuarter(Calendar cal)
    {

    }

    public static Calendar getFirstDayOfYear(Calendar cal)
    {
