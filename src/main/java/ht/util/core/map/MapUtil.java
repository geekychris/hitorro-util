...
import ht.util.core.*;
import ht.util.core.params.KeyMap;
...
public class MapUtil {
    ...
    public static final boolean getBooleanColumnFromColumMap(String name,
        ...
        return BooleanUtil.getBoolean(s);
    }
    ...
    public static final Integer getIntegerFromMapStringValue(Map map,
        ...
        if (value != null) {
            if (value instanceof String) {
                return Constants.getInteger(Integer.parseInt(((String) value)
                        .trim()));
            }
        }
        return null;
    ...
    public static final List<GenericKeyValue> getKeyValueListFromMap(Map<String, Object> map) {
        List<GenericKeyValue> l = new ArrayList<GenericKeyValue>();
        Set<Map.Entry<String, Object>> set = map.entrySet();
        Iterator<Map.Entry<String, Object>> iter = set.iterator();
        while (iter.hasNext()) {
            Map.Entry<String, Object> entry = iter.next();
            l.add(new GenericKeyValue(entry.getKey(), entry.getValue().toString()));
        }
        return l;
    }
    ...
    public static Map<String, String> getMapFromKeyValueCSV(File file, final String keyName, final String valueName) throws
        ...
        CSVReader csr = new CSVReader(new InputStreamReader(new FileInputStream(file), Constants.UTF8));
